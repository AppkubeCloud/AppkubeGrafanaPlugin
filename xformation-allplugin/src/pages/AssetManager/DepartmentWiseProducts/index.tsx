			...
			return departments.map((department: any, index: any) => {
				...
				return (
					<div className="department-box" key={index}>
						<Link to={`${PLUGIN_BASE_URL}/plugins/asset-manager/department-wise-products/department-wise-charts`} className="heading">
							{department.name}
						</Link>
								...
								<div className="col-lg-4 col-md-12 col-sm-12">
									<div className="cost-analysis-chart">
										...
										<div className="view-details-link">
											<Link to={`${PLUGIN_BASE_URL}/plugins/asset-manager/department-wise-charts`}>
